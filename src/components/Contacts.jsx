      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 mb-8">
          {locations.map(loc => (
            <div
              key={loc.id}
              className="contact-card bg-surface rounded-2xl p-5 border border-accent/10 hover:border-accent/30 hover:shadow-card-hover transition-all duration-300"
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-accent/10 rounded-xl flex-shrink-0 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-secondary text-sm">г. {loc.city}</p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm text-green pl-13">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-green flex-shrink-0">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <a
            ...
            className="flex items-center gap-3 px-6 py-3 bg-surface border border-accent/10 rounded-full hover:border-accent/30 hover:shadow-md transition-all duration-300"
          >
            ...
            <span className="text-sm font-semibold text-primary">{contacts.email}</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-sm font-semibold text-primary">Telegram</span>
          </a>
        </div>
